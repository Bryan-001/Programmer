...
$c_id=$_POST['customer_id'];
	...
	$_SESSION['custName']=$customer_name;
	$_SESSION['age']=$age;
	$_SESSION['sex']=$sex;
...
if(isset($_POST['drug_name']))
{
	...
	echo "<table width=\"100%\" border=1>";
        ...
        // loop through results of database query, displaying them in the table
		 $result = mysqli_query($con,"SELECT * FROM tempPrescri")or die(mysqli_connect_error());
...
$getDetails=mysql_query($con,"SELECT invoice,drug,cost,quantity FROM invoice_details WHERE invoice='{$invoice}'");
$getQuantity=mysql_query($con,"SELECT quantity FROM invoice_details WHERE invoice_id='{$invoice}'");

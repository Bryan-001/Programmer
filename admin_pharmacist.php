...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($con,"SELECT * FROM pharmacist")or die(mysqli_connect_error());
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_pharmacist.php?username=<?php echo $row['username']?>"><img src="update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
		...
		<form name="form1" onsubmit="return validateForm(this);" action="add_pharmacist1.php" method="post" >
			<table width="220" height="106" border="0" >	
				...
				<tr><td align="right"><input type="submit"  name="pharmacist" value="Submit"/></td></tr>
            </table>
		</form>
        </div>  
    </div>  
